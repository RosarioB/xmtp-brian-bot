...
declare class HandlerContext {
    ...
    private constructor();
    static loadCommandConfig(configPath?: string): Promise<SkillGroup[]>;
    static create(conversation: Conversation | Conversation$1, message: DecodedMessage | DecodedMessage$1 | null, { client, v2client }: {
        client: Client;
        v2client: Client$1;
    }, skillsConfigPath?: string, version?: "v2" | "v3"): Promise<HandlerContext>;
    ...
    skill(text: string, conversation?: Conversation): Promise<void | ApiResponse>;
    findSkill(text: string, skills: SkillGroup[]): SkillCommand | undefined;
    findSkillGroup(content: string, skills: SkillGroup[]): SkillGroup | undefined;
}
...
type SkillHandler = (context: HandlerContext) => Promise<void | ApiResponse>;
...
export { type AbstractedMember, type ApiResponse, type Config, type GroupAbstracted, type Handler, HandlerContext, type MessageAbstracted, type Metadata, type MetadataValue, type SkillCommand, type SkillGroup, type SkillHandler, type SkillParamConfig, run, xmtpClient };
